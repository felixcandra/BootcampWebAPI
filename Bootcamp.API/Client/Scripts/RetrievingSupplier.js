...
function LoadIndexSupplier() {
    ...
    $.ajax({
        ...
        url: "http://localhost:20604/api/Suppliers",
        async:false,
        datatype: "json",
...
function Edit() {
    ...
    $.ajax({
        ...
        url: "http://localhost:20604/api/Suppliers/" + $('#Id').val(),
        datatype: "json",
        data: supplier,
...
function GetById(Id) {
    $.ajax({
        url: "http://localhost:20604/api/Suppliers/" + Id, // search
        type: "GET", 
        datatype: "json",
        success: function (result) {
            $('#Id').val(result.Id);
...
function Delete(Id) {
    swal({ // popup konfirmasi delete swal 
        ...
        $.ajax({
            url: "http://localhost:20604/api/Suppliers/" + Id,
            type: "DELETE",
